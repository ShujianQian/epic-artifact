...
1. Use your brower to access [FluidStack](https://console.fluidstack.io) and then login in with the provided credentials. Click on the "Virtual Machines" tab to create a virtual machine.
